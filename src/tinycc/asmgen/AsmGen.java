...
public class AsmGen {
     ...
     */
    public AsmGen(final PrintStream out) {
        if (out == null) {
    ...
    public AsmGen(AsmGen printStreamProvider) {
    ...
    /**
     * Emits a memory instruction. The effective address is the sum of the address of the label and value of the register.
     * This variant does not print an offset.
     *
     * @param insn     The memory-instruction type to emit.
     * @param dest     The destination register to use.
     * @param label    The label to which the memory access is relative to (may be null).
    ...
    /**
     * Emits a register instruction which operates on one register and stores the result in a register. In this variant the operand is the same
     * as the destination.
     *
     * @param insn  The register-instruction type to emit.
     * @param dest  The destination register.
     * @remarks Emits into the text segment.
     */
    public void emitInstruction(final RegisterInstruction insn, final GPRegister dest) {
        if (dest == null) {
            throw new IllegalArgumentException();
        }
        emit("%s %s", insn, dest, dest);
    }
